...
parse.add_argument('--root', type=str, default='E:\project\Python\第三次竞赛\\new_data', help='path to data set')
parse.add_argument('--mode', type=str, default='validation', choices=['train', 'validation', 'inference'])
parse.add_argument('--log_path', type=str, default='E:\project\Python\第三次竞赛\\new_data\\googlenet_log_100.pth', help='dir of checkpoints')
...
if __name__ == '__main__':
    ...
    classes_txt(args.root + '/train', args.root + '/test.txt', num_class=args.num_class)
